...
We used R (Version 4.5.2; R Core Team, 2024) and the R-packages \emph{dplyr} (Version 1.1.4; Wickham et al., 2023), \emph{here} (Version 1.0.2; Müller, 2020), \emph{lavaan} (Version 0.6.20; Rosseel, 2012), \emph{papaja} (Version 0.1.4; Aust \& Barth, 2024), \emph{psych} (Version 2.5.6; Revelle, 2024), \emph{RStudio} (Posit Team, 2024), \emph{shape} (Version 1.4.6.1; Soetaert, 2024), and \emph{tinylabels} (Version 0.2.5; Barth, 2025) for our analyses.
