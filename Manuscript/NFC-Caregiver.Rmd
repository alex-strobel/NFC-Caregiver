...
It correlates with depression [@bianchi_overlap_2015], increased alcohol abuse [@oreskovich_alcohol_2012], and a heightened risk of suicidal thoughts [@shanafelt_suicide_2011]. 
As a response to excessive work stress [@maslach_burnout_1998], burnout affects not only individuals but also their workplace [@west_physicians_2018], leading to decreased productivity [@dewa_productivity_2017], reduced job satisfaction, and intentions to leave the profession [@shanafelt_satisfaction_2009].
